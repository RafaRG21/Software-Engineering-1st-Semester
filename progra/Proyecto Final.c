...
main(){
setlocale(LC_ALL,"");
int menu,smenu,imp,cont2,contador2;
char busqueda[50];
...
int result;
	...
	result=strcmp(x.asiento,search);
	if(result==0){
	printfticket(x);
